...
namespace NPOI.SS.Util
{
    ...
    public class SheetUtil
    {
        ...
        public static double GetColumnWidth(ISheet sheet, int column, bool useMergedCells)
        {
            ...
            //LJ @20180425 DotNetCore
            int defaultCharWidth = MeasureString("" + new String(defaultChar, 1), font); // TextRenderer.MeasureText("" + new String(defaultChar, 1), font).Width;
        ...
        {
            return Convert.ToInt32(Graphics.FromHwnd(IntPtr.Zero).MeasureString(text, font).Width);
        }
